...
route: ficheros
lesson_id: leccion48
lesson_file: 48-datos-no-confiables-y-validacion
lesson_number: "48"
title: Datos no confiables y validación
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion48/
lessons:
...
# Datos no confiables y validación

## Qué vas a conseguir

- Comprender **Datos no confiables y validación**.
