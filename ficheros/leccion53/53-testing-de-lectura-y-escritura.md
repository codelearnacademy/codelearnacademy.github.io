...
route: ficheros
lesson_id: leccion53
lesson_file: 53-testing-de-lectura-y-escritura
lesson_number: "53"
title: Testing de lectura y escritura
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion53/
lessons:
...
# Testing de lectura y escritura

## Qué vas a conseguir

- Comprender **Testing de lectura y escritura**.
...
<div class="cla-lesson-nav">
  <a href="/ficheros/leccion52/">← 52 · Arquitectura Reader y Writer</a>
  <a href="/ficheros/leccion54/">54 · @TempDir y recursos de prueba →</a>
</div>
