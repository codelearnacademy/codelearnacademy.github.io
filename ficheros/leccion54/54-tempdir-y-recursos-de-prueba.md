...
route: ficheros
lesson_id: leccion54
lesson_file: 54-tempdir-y-recursos-de-prueba
lesson_number: "54"
title: "@TempDir y recursos de prueba"
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion54/
lessons:
...
# @TempDir y recursos de prueba

## Qué vas a conseguir

- Comprender **@TempDir y recursos de prueba**.
