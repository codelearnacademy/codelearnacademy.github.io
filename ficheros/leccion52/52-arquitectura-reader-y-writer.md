...
route: ficheros
lesson_id: leccion52
lesson_file: 52-arquitectura-reader-y-writer
lesson_number: "52"
title: Arquitectura Reader y Writer
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion52/
lessons:
...
# Arquitectura Reader y Writer

## Qué vas a conseguir

- Comprender **Arquitectura Reader y Writer**.
...
<div class="cla-lesson-nav">
  ...
  <a href="/ficheros/leccion53/">53 · Testing de lectura y escritura →</a>
</div>
