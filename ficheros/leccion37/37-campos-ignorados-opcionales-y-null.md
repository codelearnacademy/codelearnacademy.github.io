...
route: ficheros
lesson_id: leccion37
lesson_file: 37-campos-ignorados-opcionales-y-null
lesson_number: "37"
title: Campos ignorados, opcionales y null
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion37/
lessons:
...
# Campos ignorados, opcionales y null

## Qué vas a conseguir

- Comprender **Campos ignorados, opcionales y null**.
...
<div class="cla-lesson-nav">
  <a href="/ficheros/leccion36/">← 36 · Mapeo de nombres de propiedades</a>
  <a href="/ficheros/leccion38/">38 · JsonNode y modelo de árbol →</a>
</div>
