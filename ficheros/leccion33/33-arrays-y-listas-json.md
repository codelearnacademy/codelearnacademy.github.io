...
route: ficheros
lesson_id: leccion33
lesson_file: 33-arrays-y-listas-json
lesson_number: "33"
title: Arrays y listas JSON
...
# Arrays y listas JSON

## Qué vas a conseguir

- Comprender **Arrays y listas JSON**.
...
<div class="cla-lesson-nav">
  <a href="/ficheros/leccion32/">← 32 · Leer y escribir JSON en ficheros</a>
  <a href="/ficheros/leccion34/">34 · TypeReference y genéricos →</a>
</div>
