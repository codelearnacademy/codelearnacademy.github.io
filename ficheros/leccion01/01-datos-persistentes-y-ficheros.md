...
route: ficheros
lesson_id: leccion01
lesson_file: 01-datos-persistentes-y-ficheros
lesson_number: "01"
title: Datos persistentes y ficheros
...
# Datos persistentes y ficheros

## Qué vas a conseguir

- Comprender **Datos persistentes y ficheros**.
...
Path file = dataDirectory.resolve("ejemplo.txt");
Files.createDirectories(dataDirectory);
Files.writeString(file, "Una tarea pendiente\n", StandardCharsets.UTF_8);
...
<div class="cla-lesson-nav">
  <span></span>
  <a href="/ficheros/leccion02/">02 · Rutas y Path →</a>
</div>
