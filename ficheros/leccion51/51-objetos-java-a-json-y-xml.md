...
route: ficheros
lesson_id: leccion51
lesson_file: 51-objetos-java-a-json-y-xml
lesson_number: "51"
title: Objetos Java a JSON y XML
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion51/
lessons:
...
# Objetos Java a JSON y XML

## Qué vas a conseguir

- Comprender **Objetos Java a JSON y XML**.
...
<div class="cla-lesson-nav">
  <a href="/ficheros/leccion50/">← 50 · CSV a objetos Java</a>
