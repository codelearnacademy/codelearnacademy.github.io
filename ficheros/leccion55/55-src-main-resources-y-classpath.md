...
route: ficheros
lesson_id: leccion55
lesson_file: 55-src-main-resources-y-classpath
lesson_number: "55"
title: src/main/resources y classpath
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion55/
lessons:
...
# src/main/resources y classpath

## Qué vas a conseguir

- Comprender **src/main/resources y classpath**.
