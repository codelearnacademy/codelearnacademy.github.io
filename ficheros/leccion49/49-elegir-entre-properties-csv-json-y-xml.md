...
route: ficheros
lesson_id: leccion49
lesson_file: 49-elegir-entre-properties-csv-json-y-xml
lesson_number: "49"
title: Elegir entre properties, CSV, JSON y XML
description: Ruta práctica para trabajar con ficheros y formatos de datos desde Java.
permalink: /ficheros/leccion49/
lessons:
...
# Elegir entre properties, CSV, JSON y XML

## Qué vas a conseguir

- Comprender **Elegir entre properties, CSV, JSON y XML**.
