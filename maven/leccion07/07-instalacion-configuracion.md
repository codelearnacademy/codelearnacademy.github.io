...
route: maven
lesson_id: leccion07
lesson_file: 07-instalacion-configuracion
lesson_number: "07"
title: Instalación y configuración
description: Prepara Java y Maven y aprende a diagnosticar el entorno desde terminal.
permalink: /maven/leccion07/
lessons:
...
Prepara Java y Maven y aprende a diagnosticar el entorno desde terminal.

## Qué vas a conseguir

- Comprender **JDK** en el contexto de un proyecto Maven.
- Comprender **JAVA_HOME** en el contexto de un proyecto Maven.
- Comprender **PATH** en el contexto de un proyecto Maven.
- Comprender **mvn -version** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **JDK** y observaremos su efecto en un proyecto Java sencillo.
...
Node se valida con `node -v` y `npm -v`; Python con `python --version`; Go con `go version`. El patrón es el mismo: comprobar primero el toolchain.
...
1. Comprueba las versiones instaladas en tu equipo.
2. Explica qué información de `mvn -version` te permite verificar el JDK utilizado.
