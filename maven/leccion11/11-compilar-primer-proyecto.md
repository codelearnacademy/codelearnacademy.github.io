...
route: maven
lesson_id: leccion11
lesson_file: 11-compilar-primer-proyecto
lesson_number: "11"
title: Compilar el primer proyecto
description: Compila un proyecto Maven y observa qué genera realmente la fase compile.
permalink: /maven/leccion11/
lessons:
...
Compila un proyecto Maven y observa qué genera realmente la fase compile.

## Qué vas a conseguir

- Comprender **mvn compile** en el contexto de un proyecto Maven.
- Comprender **target/classes** en el contexto de un proyecto Maven.
- Comprender **bytecode** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **mvn compile** y observaremos su efecto en un proyecto Java sencillo.
...
En Go `go build` genera un binario; en Java Maven delega la compilación al plugin correspondiente y produce `.class` dentro del build directory.
...
1. Ejecuta `mvn compile` y localiza los `.class`.
2. Modifica una clase y comprueba qué cambia en `target/classes`.
...
<div class="cla-lesson-nav">
  ...
  <a href="/maven/leccion12/">12 · El ciclo de vida de Maven →</a>
</div>
