...
route: maven
lesson_id: leccion21
lesson_file: 21-versiones-conflictos
lesson_number: "21"
title: Versiones y conflictos
description: Diagnostica situaciones donde varias dependencias requieren versiones diferentes.
permalink: /maven/leccion21/
lessons:
...
Diagnostica situaciones donde varias dependencias requieren versiones diferentes.

## Qué vas a conseguir

- Comprender **mediación** en el contexto de un proyecto Maven.
- Comprender **conflictos de versiones** en el contexto de un proyecto Maven.
- Comprender **dependency:tree** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **mediación** y observaremos su efecto en un proyecto Java sencillo.
...
Los conflictos de versiones aparecen también en npm, Python y .NET. Cada ecosistema tiene reglas diferentes para seleccionar, aislar o bloquear versiones.
...
1. Analiza un árbol con versiones repetidas.
2. Explica cómo detectarías qué dependencia introduce una versión concreta.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion20/">← 20 · Scopes de dependencias</a>
