...
route: maven
lesson_id: leccion19
lesson_file: 19-dependencias-transitivas
lesson_number: "19"
title: Dependencias transitivas
description: Comprende por qué una dependencia puede incorporar otras sin declararlas directamente.
permalink: /maven/leccion19/
lessons:
...
Comprende por qué una dependencia puede incorporar otras sin declararlas directamente.

## Qué vas a conseguir

- Comprender **transitividad** en el contexto de un proyecto Maven.
- Comprender **árbol de dependencias** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **transitividad** y observaremos su efecto en un proyecto Java sencillo.
...
npm y Python también resuelven árboles de dependencias. El problema de transitividad es común a prácticamente todos los gestores de paquetes.
...
1. Genera el árbol de dependencias de tu proyecto.
2. Clasifica dependencias como directas o transitivas.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion18/">← 18 · El repositorio local .m2</a>
