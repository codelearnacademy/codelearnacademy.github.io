...
route: maven
lesson_id: leccion18
lesson_file: 18-repositorio-local-m2
lesson_number: "18"
title: El repositorio local .m2
description: Explora la caché local de Maven y comprende cómo reutiliza artefactos descargados.
permalink: /maven/leccion18/
lessons:
...
Explora la caché local de Maven y comprende cómo reutiliza artefactos descargados.

## Qué vas a conseguir

- Comprender **~/.m2/repository** en el contexto de un proyecto Maven.
- Comprender **caché local** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **~/.m2/repository** y observaremos su efecto en un proyecto Java sencillo.
...
npm, pip y Go también mantienen cachés locales. La finalidad es evitar descargas repetidas y acelerar builds.
...
1. Localiza una dependencia descargada en `.m2`.
2. Borra de forma controlada una versión concreta y vuelve a ejecutar Maven para observar qué sucede.
