...
route: maven
lesson_id: leccion08
lesson_file: 08-crear-proyecto-maven
lesson_number: "08"
title: Crear un proyecto Maven
description: Construye manualmente la estructura mínima de un proyecto Maven para entenderla antes de usar asistentes.
permalink: /maven/leccion08/
lessons:
...
Construye manualmente la estructura mínima de un proyecto Maven para entenderla antes de usar asistentes.

## Qué vas a conseguir

- Comprender **src/main/java** en el contexto de un proyecto Maven.
- Comprender **src/test/java** en el contexto de un proyecto Maven.
- Comprender **pom.xml** en el contexto de un proyecto Maven.
- Comprender **convención** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **src/main/java** y observaremos su efecto en un proyecto Java sencillo.
...
Maven favorece convención sobre configuración. Frameworks como Spring Boot, herramientas como Gradle y muchos proyectos Node también adoptan estructuras convencionales para reducir decisiones repetitivas.
...
1. Crea la estructura mínima de un proyecto Maven.
2. Añade un paquete `com.codelearn.demo` y una clase `Main`.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion07/">← 07 · Instalación y configuración</a>
  <a href="/maven/leccion09/">09 · Anatomía del pom.xml →</a>
</div>
