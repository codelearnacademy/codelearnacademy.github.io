...
route: maven
lesson_id: leccion28
lesson_file: 28-configurar-java21
lesson_number: "28"
title: Configurar Java 21
description: Declara explícitamente la versión de Java esperada por el proyecto.
permalink: /maven/leccion28/
lessons:
...
Declara explícitamente la versión de Java esperada por el proyecto.

## Qué vas a conseguir

- Comprender **maven.compiler.release** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **maven.compiler.release** y observaremos su efecto en un proyecto Java sencillo.
...
La idea es similar a declarar versiones de runtime o toolchain en otros ecosistemas para evitar depender de la configuración personal del desarrollador.
...
1. Configura Java 21.
2. Prueba una versión incompatible y analiza el error.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion27/">← 27 · Goals y fases</a>
