...
route: maven
lesson_id: leccion17
lesson_file: 17-maven-central
lesson_number: "17"
title: Maven Central
description: Comprende de dónde obtiene Maven muchas de las dependencias públicas.
permalink: /maven/leccion17/
lessons:
...
Comprende de dónde obtiene Maven muchas de las dependencias públicas.

## Qué vas a conseguir

- Comprender **Maven Central** en el contexto de un proyecto Maven.
- Comprender **repositorios** en el contexto de un proyecto Maven.
- Comprender **coordenadas** en el contexto de un proyecto Maven.
- Comprender **metadatos** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **Maven Central** y observaremos su efecto en un proyecto Java sencillo.
...
```text
pom.xml → Maven → Maven Central → ~/.m2/repository
```
...
Maven Central cumple un papel comparable al npm registry o PyPI, aunque los formatos y reglas de publicación son distintos.
...
1. Busca las coordenadas de JUnit Jupiter.
2. Anota groupId, artifactId y versión de dos bibliotecas.
