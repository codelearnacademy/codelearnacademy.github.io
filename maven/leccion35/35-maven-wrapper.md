...
route: maven
lesson_id: leccion35
lesson_file: 35-maven-wrapper
lesson_number: "35"
title: Maven Wrapper
description: Haz que el proyecto pueda usar una versión controlada de Maven sin depender de una instalación global.
permalink: /maven/leccion35/
lessons:
...
Haz que el proyecto pueda usar una versión controlada de Maven sin depender de una instalación global.

## Qué vas a conseguir

- Comprender **mvnw** en el contexto de un proyecto Maven.
- Comprender **.mvn** en el contexto de un proyecto Maven.
- Comprender **reproducibilidad** en el contexto de un proyecto Maven.
- Comprender **toolchain** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **mvnw** y observaremos su efecto en un proyecto Java sencillo.
...
## Por qué usar Wrapper en clase

El Wrapper reduce el clásico problema:

> «En mi ordenador funciona, pero yo tengo otra versión de Maven».

El repositorio contiene los archivos necesarios para solicitar una versión concreta. De este modo, alumnado, profesorado y CI comparten el mismo punto de entrada:
...
Es equivalente en propósito al Gradle Wrapper. En otros ecosistemas se logra con lockfiles, herramientas de runtime o gestores de versiones.
...
1. Añade Maven Wrapper al proyecto.
2. Clona el proyecto en otro entorno y ejecútalo con `./mvnw`.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion34/">← 34 · dependencyManagement</a>
  <a href="/maven/leccion36/">36 · Qué versionar con Git →</a>
</div>
