...
route: maven
lesson_id: leccion32
lesson_file: 32-recursos
lesson_number: "32"
title: Recursos del proyecto
description: Utiliza archivos de configuración y otros recursos dentro de un proyecto Maven.
permalink: /maven/leccion32/
lessons:
...
Utiliza archivos de configuración y otros recursos dentro de un proyecto Maven.

## Qué vas a conseguir

- Comprender **src/main/resources** en el contexto de un proyecto Maven.
- Comprender **src/test/resources** en el contexto de un proyecto Maven.
- Comprender **classpath resources** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **src/main/resources** y observaremos su efecto en un proyecto Java sencillo.
...
Spring Boot utiliza intensamente `src/main/resources`. Node y Python también empaquetan recursos, aunque con mecanismos diferentes.
...
1. Añade un archivo de texto a `src/main/resources` y léelo.
2. Crea un recurso exclusivo para pruebas.
