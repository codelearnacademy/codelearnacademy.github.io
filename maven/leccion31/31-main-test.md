...
route: maven
lesson_id: leccion31
lesson_file: 31-main-test
lesson_number: "31"
title: Código de producción y pruebas
description: Profundiza en la separación entre código productivo y código de pruebas.
permalink: /maven/leccion31/
lessons:
...
---
# Código de producción y pruebas

Profundiza en la separación entre código productivo y código de pruebas.

## Qué vas a conseguir

- Comprender **main** en el contexto de un proyecto Maven.
- Comprender **test** en el contexto de un proyecto Maven.
- Comprender **classpath separado** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **main** y observaremos su efecto en un proyecto Java sencillo.
...
La separación existe en frameworks como Jest, pytest y Go test aunque sus convenciones de carpetas o nombres sean diferentes.
...
1. Mueve una clase a la ubicación incorrecta y observa el efecto.
2. Explica por qué una utilidad de test no debe ir normalmente en producción.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion30/">← 30 · Ejecutar el artefacto</a>
  <a href="/maven/leccion32/">32 · Recursos del proyecto →</a>
</div>
