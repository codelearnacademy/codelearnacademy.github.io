...
route: maven
lesson_id: leccion44
lesson_file: 44-romper-reparar-build
lesson_number: "44"
title: Romper y reparar el build
description: Aprende a diagnosticar un pipeline fallido provocando y corrigiendo un error real.
permalink: /maven/leccion44/
lessons:
...
---
# Romper y reparar el build

Aprende a diagnosticar un pipeline fallido provocando y corrigiendo un error real.

## Qué vas a conseguir

- Comprender **diagnóstico** en el contexto de un proyecto Maven.
- Comprender **logs** en el contexto de un proyecto Maven.
- Comprender **test failure** en el contexto de un proyecto Maven.
- Comprender **CI feedback** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **diagnóstico** y observaremos su efecto en un proyecto Java sencillo.
...
La disciplina es idéntica en cualquier stack: el sistema de CI debe detectar rápidamente regresiones antes de integrar o desplegar.
...
1. Provoca el fallo de una prueba y publícalo en una rama.
2. Corrige el problema y documenta qué línea del log te ayudó a encontrarlo.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion43/">← 43 · Maven con GitLab CI</a>
  <a href="/maven/leccion45/">45 · Maven frente a Gradle →</a>
</div>
