...
route: maven
lesson_id: leccion13
lesson_file: 13-clean-compile-test-package
lesson_number: "13"
title: clean, compile, test y package
description: Practica los comandos Maven que usarás diariamente.
permalink: /maven/leccion13/
lessons:
...
---
# clean, compile, test y package

Practica los comandos Maven que usarás diariamente.

## Qué vas a conseguir

- Comprender **mvn clean** en el contexto de un proyecto Maven.
- Comprender **mvn compile** en el contexto de un proyecto Maven.
- Comprender **mvn test** en el contexto de un proyecto Maven.
- Comprender **mvn package** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **mvn clean** y observaremos su efecto en un proyecto Java sencillo.
...
La idea de limpiar, probar y empaquetar existe también en Gradle (`clean`, `test`, `build`), npm scripts y herramientas de CI.
...
1. Ejecuta las cuatro órdenes y anota los cambios en `target`.
2. Compara `mvn test` con `mvn package`.
