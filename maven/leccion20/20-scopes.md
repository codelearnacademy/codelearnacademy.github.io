...
route: maven
lesson_id: leccion20
lesson_file: 20-scopes
lesson_number: "20"
title: Scopes de dependencias
description: Aprende cuándo una dependencia está disponible durante compilación, pruebas o ejecución.
permalink: /maven/leccion20/
lessons:
...
Aprende cuándo una dependencia está disponible durante compilación, pruebas o ejecución.

## Qué vas a conseguir

- Comprender **compile** en el contexto de un proyecto Maven.
- Comprender **test** en el contexto de un proyecto Maven.
- Comprender **runtime** en el contexto de un proyecto Maven.
- Comprender **provided** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **compile** y observaremos su efecto en un proyecto Java sencillo.
...
Los scopes de Maven no tienen un equivalente idéntico en npm, aunque `dependencies` y `devDependencies` expresan una separación parecida. En Python suele resolverse con grupos de dependencias.
...
1. Decide el scope apropiado para JUnit.
2. Explica por qué una dependencia de pruebas no debería formar parte del runtime de producción.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion19/">← 19 · Dependencias transitivas</a>
  <a href="/maven/leccion21/">21 · Versiones y conflictos →</a>
</div>
