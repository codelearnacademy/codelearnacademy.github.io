...
route: maven
lesson_id: leccion09
lesson_file: 09-anatomia-pom
lesson_number: "09"
title: Anatomía del pom.xml
description: Comprende los elementos esenciales del Project Object Model de Maven.
permalink: /maven/leccion09/
lessons:
...
---
# Anatomía del pom.xml

Comprende los elementos esenciales del Project Object Model de Maven.

## Qué vas a conseguir

- Comprender **project** en el contexto de un proyecto Maven.
- Comprender **modelVersion** en el contexto de un proyecto Maven.
- Comprender **groupId** en el contexto de un proyecto Maven.
- Comprender **artifactId** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **project** y observaremos su efecto en un proyecto Java sencillo.
...
`pom.xml` cumple un papel similar al `package.json` de Node o `pyproject.toml` en Python: describe el proyecto y parte de su configuración.
...
1. Crea un POM mínimo válido.
2. Explica con tus palabras qué representan `groupId`, `artifactId` y `version`.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion08/">← 08 · Crear un proyecto Maven</a>
  <a href="/maven/leccion10/">10 · Coordenadas Maven →</a>
</div>
