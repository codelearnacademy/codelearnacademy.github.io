...
route: maven
lesson_id: leccion33
lesson_file: 33-properties-pom
lesson_number: "33"
title: Properties del POM
description: Centraliza versiones y parámetros para mantener un POM más claro.
permalink: /maven/leccion33/
lessons:
...
Centraliza versiones y parámetros para mantener un POM más claro.

## Qué vas a conseguir

- Comprender **properties** en el contexto de un proyecto Maven.
- Comprender **reutilización** en el contexto de un proyecto Maven.
- Comprender **versiones** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **properties** y observaremos su efecto en un proyecto Java sencillo.
...
Centralizar versiones se parece al uso de variables, catálogos o ficheros de configuración en otros sistemas de build.
...
1. Extrae una versión repetida a una property.
2. Añade una property propia y úsala desde otra sección del POM.
