...
route: maven
lesson_id: leccion10
lesson_file: 10-coordenadas-maven
lesson_number: "10"
title: Coordenadas Maven
description: Aprende cómo Maven identifica de forma única proyectos y dependencias.
permalink: /maven/leccion10/
lessons:
...
Aprende cómo Maven identifica de forma única proyectos y dependencias.

## Qué vas a conseguir

- Comprender **groupId** en el contexto de un proyecto Maven.
- Comprender **artifactId** en el contexto de un proyecto Maven.
- Comprender **version** en el contexto de un proyecto Maven.
- Comprender **packaging** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **groupId** y observaremos su efecto en un proyecto Java sencillo.
...
```text
com.codelearn:calculadora:1.0.0
```
...
npm identifica paquetes principalmente por nombre y versión; Maven utiliza coordenadas compuestas. Go suele identificar módulos mediante una ruta de módulo y versión.
...
1. Escribe las coordenadas de tu proyecto.
2. Interpreta las coordenadas de una dependencia pública.
