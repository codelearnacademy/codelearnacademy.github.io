...
route: maven
lesson_id: leccion29
lesson_file: 29-empaquetar-aplicacion
lesson_number: "29"
title: Empaquetar una aplicación
description: Genera un JAR y comprende qué contiene el artefacto.
permalink: /maven/leccion29/
lessons:
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **mvn package** y observaremos su efecto en un proyecto Java sencillo.
...
El equivalente conceptual puede ser un bundle de frontend, una wheel de Python o un binario Go: un resultado distribuible de un proceso de construcción.
...
1. Genera el JAR y lista su contenido.
2. Comprueba qué ocurre si las pruebas fallan antes del empaquetado.
