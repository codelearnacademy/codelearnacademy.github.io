...
route: maven
lesson_id: leccion01
lesson_file: 01-de-codigo-fuente-a-aplicacion
lesson_number: "01"
title: De código fuente a aplicación
description: Comprende qué significa construir una aplicación Java antes de introducir Maven.
permalink: /maven/leccion01/
lessons:
...
---
# De código fuente a aplicación

Comprende qué significa construir una aplicación Java antes de introducir Maven.

## Qué vas a conseguir

- Comprender **código fuente** en el contexto de un proyecto Maven.
- Comprender **compilación** en el contexto de un proyecto Maven.
- Comprender **bytecode** en el contexto de un proyecto Maven.
- Comprender **pruebas** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **código fuente** y observaremos su efecto en un proyecto Java sencillo.
...
En Java la compilación es explícita. En JavaScript normalmente se ejecuta directamente o se transpila/bundea; en Python el foco suele estar en el intérprete y el empaquetado; en Go `go build` integra gran parte del proceso.
...
1. Describe las etapas necesarias para entregar una aplicación Java sencilla.
2. Diferencia código fuente, bytecode y artefacto distribuible.
...
<div class="cla-lesson-nav">
  <span></span>
  <a href="/maven/leccion02/">02 · Construir un proyecto Java sin Maven →</a>
</div>
