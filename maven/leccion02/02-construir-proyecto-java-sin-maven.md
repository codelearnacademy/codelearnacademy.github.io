...
route: maven
lesson_id: leccion02
lesson_file: 02-construir-proyecto-java-sin-maven
lesson_number: "02"
title: Construir un proyecto Java sin Maven
description: Experimenta las dificultades de compilar, ejecutar y distribuir un proyecto Java manualmente.
permalink: /maven/leccion02/
lessons:
...
---
# Construir un proyecto Java sin Maven

Experimenta las dificultades de compilar, ejecutar y distribuir un proyecto Java manualmente.

## Qué vas a conseguir

- Comprender **classpath** en el contexto de un proyecto Maven.
- Comprender **javac** en el contexto de un proyecto Maven.
- Comprender **java** en el contexto de un proyecto Maven.
- Comprender **directorios de salida** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **classpath** y observaremos su efecto en un proyecto Java sencillo.
...
```bash
mkdir -p out
javac -d out src/com/codelearn/App.java
java -cp out com.codelearn.App
```
...
El equivalente conceptual sería gestionar a mano `node_modules` en JavaScript, copiar paquetes Python dentro del proyecto o compilar dependencias Go manualmente: posible, pero poco reproducible.
...
1. Compila dos clases relacionadas sin usar Maven.
2. Explica qué tendría que hacer otra persona para ejecutar tu proyecto en otro equipo.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion01/">← 01 · De código fuente a aplicación</a>
