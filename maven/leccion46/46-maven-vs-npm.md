...
route: maven
lesson_id: leccion46
lesson_file: 46-maven-vs-npm
lesson_number: "46"
title: Maven frente a npm
description: Relaciona la gestión de proyectos Maven con el ecosistema Node.js.
permalink: /maven/leccion46/
lessons:
...
Relaciona la gestión de proyectos Maven con el ecosistema Node.js.

## Qué vas a conseguir

- Comprender **package.json** en el contexto de un proyecto Maven.
- Comprender **dependencies** en el contexto de un proyecto Maven.
- Comprender **scripts** en el contexto de un proyecto Maven.
- Comprender **registry** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **package.json** y observaremos su efecto en un proyecto Java sencillo.
...
npm es principalmente gestor de paquetes con scripts; Maven integra además un lifecycle de build formal y plugins ligados a fases.
...
1. Identifica tres similitudes y tres diferencias.
2. Busca un proyecto Node y localiza sus dependencias y scripts.
