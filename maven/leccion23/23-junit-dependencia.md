...
route: maven
lesson_id: leccion23
lesson_file: 23-junit-dependencia
lesson_number: "23"
title: JUnit como dependencia
description: Añade JUnit correctamente y relaciona testing con la gestión de dependencias.
permalink: /maven/leccion23/
lessons:
...
---
# JUnit como dependencia

Añade JUnit correctamente y relaciona testing con la gestión de dependencias.

## Qué vas a conseguir

- Comprender **JUnit Jupiter** en el contexto de un proyecto Maven.
- Comprender **scope test** en el contexto de un proyecto Maven.
- Comprender **dependencia de pruebas** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **JUnit Jupiter** y observaremos su efecto en un proyecto Java sencillo.
...
No buscamos dominar JUnit todavía. El objetivo es observar cómo una dependencia de test participa en el ciclo de vida de Maven.


## Conexión con otros ecosistemas

Jest en JavaScript y pytest en Python cumplen roles parecidos como frameworks de pruebas; Maven no sustituye a JUnit, sino que integra su ejecución en el build.
...
1. Añade JUnit a un proyecto.
2. Escribe una prueba para una suma.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion22/">← 22 · Estructura de pruebas</a>
  <a href="/maven/leccion24/">24 · Ejecutar pruebas con Maven →</a>
</div>
