...
route: maven
lesson_id: leccion41
lesson_file: 41-maven-pipeline
lesson_number: "41"
title: Maven dentro de un pipeline
description: Define los pasos mínimos de un pipeline para un proyecto Maven.
permalink: /maven/leccion41/
lessons:
...
---
# Maven dentro de un pipeline

Define los pasos mínimos de un pipeline para un proyecto Maven.

## Qué vas a conseguir

- Comprender **checkout** en el contexto de un proyecto Maven.
- Comprender **setup JDK** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **checkout** y observaremos su efecto en un proyecto Java sencillo.
...
Para Node usaríamos algo como `npm ci && npm test`; en Python, instalación + `pytest`; en Go, `go test ./...`.
...
1. Diseña un pipeline agnóstico de proveedor.
2. Relaciona cada paso con su equivalente local.
