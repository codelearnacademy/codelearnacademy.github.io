...
route: maven
lesson_id: leccion42
lesson_file: 42-github-actions
lesson_number: "42"
title: Maven con GitHub Actions
description: Automatiza la compilación y las pruebas de Maven en GitHub.
permalink: /maven/leccion42/
lessons:
...
---
# Maven con GitHub Actions

Automatiza la compilación y las pruebas de Maven en GitHub.

## Qué vas a conseguir

- Comprender **GitHub Actions** en el contexto de un proyecto Maven.
- Comprender **workflow** en el contexto de un proyecto Maven.
- Comprender **JDK** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **GitHub Actions** y observaremos su efecto en un proyecto Java sencillo.
...
El workflow no sustituye Maven. Simplemente ejecuta de forma automática el mismo build que debería funcionar en local.


## Conexión con otros ecosistemas

GitHub Actions es el orquestador; Maven sigue siendo la herramienta que sabe construir el proyecto Java.
...
1. Crea un workflow mínimo.
2. Haz un push que active el workflow y analiza el resultado.
