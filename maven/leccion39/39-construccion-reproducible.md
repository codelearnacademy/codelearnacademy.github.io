...
route: maven
lesson_id: leccion39
lesson_file: 39-construccion-reproducible
lesson_number: "39"
title: Construcciones reproducibles
description: Comprueba que otra persona puede clonar y construir exactamente el mismo proyecto.
permalink: /maven/leccion39/
lessons:
...
Comprueba que otra persona puede clonar y construir exactamente el mismo proyecto.

## Qué vas a conseguir

- Comprender **clone** en el contexto de un proyecto Maven.
- Comprender **wrapper** en el contexto de un proyecto Maven.
- Comprender **dependencias declaradas** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **clone** y observaremos su efecto en un proyecto Java sencillo.
...
Lockfiles en npm/Python y módulos versionados en Go persiguen el mismo objetivo: reducir diferencias entre equipos y entornos.
...
1. Intercambia un repositorio con un compañero y construidlo desde cero.
2. Anota cualquier dependencia implícita del entorno que descubras.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion38/">← 38 · Maven dentro del flujo Git</a>
  <a href="/maven/leccion40/">40 · Introducción a la integración continua →</a>
</div>
