...
route: maven
lesson_id: leccion24
lesson_file: 24-ejecutar-pruebas
lesson_number: "24"
title: Ejecutar pruebas con Maven
description: Ejecuta pruebas automáticamente desde Maven y lee su resultado.
permalink: /maven/leccion24/
lessons:
...
Ejecuta pruebas automáticamente desde Maven y lee su resultado.

## Qué vas a conseguir

- Comprender **mvn test** en el contexto de un proyecto Maven.
- Comprender **Surefire** en el contexto de un proyecto Maven.
- Comprender **reportes** en el contexto de un proyecto Maven.
- Comprender **BUILD SUCCESS** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **mvn test** y observaremos su efecto en un proyecto Java sencillo.
...
La misma idea existe con `npm test`, `pytest` o `go test`. La diferencia es cómo cada ecosistema conecta el runner con su herramienta de build.
...
1. Ejecuta una prueba correcta.
2. Provoca un fallo y localiza el mensaje relevante en la salida.
