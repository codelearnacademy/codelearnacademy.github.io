...
route: maven
lesson_id: leccion34
lesson_file: 34-dependencymanagement
lesson_number: "34"
title: dependencyManagement
description: Comprende cómo centralizar versiones sin añadir automáticamente dependencias.
permalink: /maven/leccion34/
lessons:
...
Comprende cómo centralizar versiones sin añadir automáticamente dependencias.

## Qué vas a conseguir

- Comprender **dependencyManagement** en el contexto de un proyecto Maven.
- Comprender **herencia** en el contexto de un proyecto Maven.
- Comprender **version alignment** en el contexto de un proyecto Maven.
...
Maven se entiende mejor cuando cada concepto se conecta con una necesidad concreta del proyecto. En esta lección nos centraremos en **dependencyManagement** y observaremos su efecto en un proyecto Java sencillo.
...
La idea se relaciona con BOMs, catálogos de versiones de Gradle y mecanismos de constraints presentes en otros gestores.
...
1. Explica por qué `dependencyManagement` no añade una biblioteca por sí solo.
2. Centraliza la versión de JUnit usando esta sección.
...
<div class="cla-lesson-nav">
  <a href="/maven/leccion33/">← 33 · Properties del POM</a>
  <a href="/maven/leccion35/">35 · Maven Wrapper →</a>
</div>
