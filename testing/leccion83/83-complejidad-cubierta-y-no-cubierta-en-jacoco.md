...
route: testing
lesson_id: leccion83
lesson_file: 83-complejidad-cubierta-y-no-cubierta-en-jacoco
lesson_number: "83"
title: Complejidad cubierta y no cubierta en JaCoCo
...
```text
JaCoCo muestra complejidad cubierta y perdida; PMD puede imponer límites estáticos por método.
```
...
<div class="cla-lesson-nav">
  <a href="/testing/leccion82/">← 82 · Decisiones, ramas y caminos de ejecución</a>
