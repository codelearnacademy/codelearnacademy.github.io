...
route: testing
lesson_id: leccion46
lesson_file: 46-introduccion-a-assertj
lesson_number: "46"
title: Introducción a AssertJ
...
```text
AssertJ 3.27.7: `assertThat(value).isNotNull().isEqualTo(expected);`
```
