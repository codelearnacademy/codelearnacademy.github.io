...
route: testing
lesson_id: leccion89
lesson_file: 89-testing-automatico-en-github-actions-y-gitlab-ci
lesson_number: "89"
title: Testing automático en GitHub Actions y GitLab CI
...
# Testing automático en GitHub Actions y GitLab CI
...
- Comprender **Testing automático en GitHub Actions y GitLab CI**.
...
```text
CI: checkout → Java 21 → `./mvnw clean verify` → publicar reportes.
```
...
<div class="cla-lesson-nav">
  ...
  <a href="/testing/leccion90/">90 · Proyecto final · Sistema Java con quality gate →</a>
</div>
