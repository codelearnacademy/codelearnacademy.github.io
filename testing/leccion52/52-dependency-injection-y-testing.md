...
- Comprender **Dependency Injection y testing**.
...
```text
Constructor injection permite sustituir repositorios, gateways o clocks durante una prueba.
```
