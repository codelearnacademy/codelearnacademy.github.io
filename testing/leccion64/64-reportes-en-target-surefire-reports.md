...
route: testing
lesson_id: leccion64
lesson_file: 64-reportes-en-target-surefire-reports
lesson_number: "64"
title: Reportes en target/surefire-reports
description: Bloque «Maven Surefire». Trabaja el concepto desde Java 21 y llévalo siempre al build reproducible de Maven.
permalink: /testing/leccion64/
lessons:
...
- Comprender **Reportes en target/surefire-reports**.
...
```text
Los resultados se escriben en `target/surefire-reports/`.
```
...
<div class="cla-lesson-nav">
  <a href="/testing/leccion63/">← 63 · Cómo detecta Maven los tests unitarios</a>
