...
route: testing
lesson_id: leccion07
lesson_file: 07-pruebas-de-integracion
lesson_number: "07"
...
- Comprender **Pruebas de integración**.
...
```text
Integration test: `OrderRepository → JDBC → PostgreSQL real`.
```
