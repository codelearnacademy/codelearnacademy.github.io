...
route: testing
lesson_id: leccion28
lesson_file: 28-comprobar-excepciones-con-assertthrows
lesson_number: "28"
title: Comprobar excepciones con assertThrows
description: Bloque «Assertions». Trabaja el concepto desde Java 21 y llévalo siempre al build reproducible de Maven.
permalink: /testing/leccion28/
lessons:
...
```text
assertThrows(IllegalArgumentException.class, () -> service.createInvalid());
```
