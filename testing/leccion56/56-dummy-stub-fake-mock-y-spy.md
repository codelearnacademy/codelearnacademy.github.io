...
route: testing
lesson_id: leccion56
lesson_file: 56-dummy-stub-fake-mock-y-spy
lesson_number: "56"
title: Dummy, Stub, Fake, Mock y Spy
...
```text
Dummy, Stub, Fake, Mock y Spy no significan lo mismo: elige el test double por intención.
```
...
<div class="cla-lesson-nav">
  ...
  <a href="/testing/leccion57/">57 · Añadir Mockito mediante Maven →</a>
</div>
