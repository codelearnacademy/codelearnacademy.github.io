...
route: testing
lesson_id: leccion81
lesson_file: 81-introduccion-a-la-complejidad-ciclomatica
lesson_number: "81"
title: Introducción a la complejidad ciclomática
...
- Comprender **Introducción a la complejidad ciclomática**.
...
```text
La complejidad ciclomática aumenta con puntos de decisión y caminos independientes.
```
...
<div class="cla-lesson-nav">
  <a href="/testing/leccion80/">← 80 · Integrar JaCoCo en mvn verify</a>
