...
route: testing
lesson_id: leccion38
lesson_file: 38-parameterizedtest-y-valuesource
lesson_number: "38"
title: "@ParameterizedTest y @ValueSource"
...
```java
@ParameterizedTest + @ValueSource permite ejecutar la misma regla con varios valores.
```
