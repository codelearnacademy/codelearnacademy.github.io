...
route: testing
lesson_id: leccion01
lesson_file: 01-introduccion-al-testing-de-software
lesson_number: "01"
...
- Comprender **Introducción al testing de software**.
...
```text
Código → comportamiento esperado → prueba automatizada → feedback antes de producción.
```
