...
route: testing
lesson_id: leccion79
lesson_file: 79-generar-y-leer-el-informe-html-de-jacoco
lesson_number: "79"
title: Generar y leer el informe HTML de JaCoCo
description: Bloque «JaCoCo y Maven». Trabaja el concepto desde Java 21 y llévalo siempre al build reproducible de Maven.
permalink: /testing/leccion79/
lessons:
...
<div class="cla-lesson-nav">
  <a href="/testing/leccion78/">← 78 · prepare-agent y ejecución de los tests</a>
