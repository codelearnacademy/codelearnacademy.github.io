...
route: testing
lesson_id: leccion11
lesson_file: 11-la-piramide-de-testing
lesson_number: "11"
...
- Comprender **La pirámide de testing**.
...
```text
Pirámide: muchas unitarias, menos integración y pocas E2E; úsala como estrategia de coste, no como dogma.
```
