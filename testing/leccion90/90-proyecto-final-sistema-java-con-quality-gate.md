...
route: testing
lesson_id: leccion90
lesson_file: 90-proyecto-final-sistema-java-con-quality-gate
lesson_number: "90"
title: Proyecto final · Sistema Java con quality gate
...
# Proyecto final · Sistema Java con quality gate
...
- Comprender **Proyecto final · Sistema Java con quality gate**.
...
```text
Proyecto final: unit tests + integration tests + JaCoCo + PMD + CI; un único comando debe decidir BUILD SUCCESS/FAILURE.
```

## Requisitos del proyecto final

`./mvnw clean verify` debe compilar Java 21, ejecutar Surefire, Failsafe, Testcontainers, JaCoCo, quality gates y análisis de complejidad.

Criterios docentes: LINE >= 80 %, BRANCH >= 70 %, complejidad ciclomática por método <= 10.
