...
route: testing
lesson_id: leccion06
lesson_file: 06-pruebas-unitarias
lesson_number: "06"
...
```text
Una unit test comprueba una unidad aislada y debería ser rápida, determinista y sin infraestructura externa.
```
