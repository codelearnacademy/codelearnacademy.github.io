...
route: testing
lesson_id: leccion73
lesson_file: 73-cobertura-de-ramas
lesson_number: "73"
title: Cobertura de ramas
...
```text
Branch coverage obliga a cubrir caminos de `if` y `switch`.
```
...
<div class="cla-lesson-nav">
  <a href="/testing/leccion72/">← 72 · Cobertura de instrucciones y líneas</a>
