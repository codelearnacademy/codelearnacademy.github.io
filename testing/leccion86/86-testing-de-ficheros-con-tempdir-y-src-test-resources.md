...
route: testing
lesson_id: leccion86
lesson_file: 86-testing-de-ficheros-con-tempdir-y-src-test-resources
lesson_number: "86"
title: Testing de ficheros con @TempDir y src/test/resources
...
# Testing de ficheros con @TempDir y src/test/resources
...
- Comprender **Testing de ficheros con @TempDir y src/test/resources**.
...
```java
@TempDir permite probar escritura sin contaminar el proyecto.
```
