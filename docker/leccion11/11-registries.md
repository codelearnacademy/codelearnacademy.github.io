...
route: docker
lesson_id: leccion11
lesson_file: 11-registries
lesson_number: "11"
title: Docker Hub y registries
description: Comprende dónde se publican y distribuyen imágenes de contenedor.
permalink: /docker/leccion11/
lessons:
...
Comprende dónde se publican y distribuyen imágenes de contenedor.

## Qué vas a conseguir

- Comprender **registry**.
- Comprender **repository**.
- Comprender **Docker Hub**.
- Comprender **GHCR**.
...
Ejemplos de registries: Docker Hub, GitHub Container Registry y GitLab Container Registry.
...
GitHub/GitLab pueden alojar tanto código como imágenes, pero son recursos diferentes: el repositorio Git contiene fuentes; el registry contiene artefactos de contenedor.
...
1. Explica la diferencia entre repositorio Git y registry de imágenes.
2. Identifica nombre de registry, repositorio y tag en una referencia completa.
