...
route: docker
lesson_id: leccion33
lesson_file: 33-aplicaciones-multicontenedor
lesson_number: "33"
title: Aplicaciones multicontenedor
description: Identifica cuándo una aplicación debe dividirse en varios servicios especializados.
permalink: /docker/leccion33/
lessons:
...
Identifica cuándo una aplicación debe dividirse en varios servicios especializados.
...
- Comprender **backend**.
- Comprender **database**.
- Comprender **separación de responsabilidades**.
...
Separar frontend, backend y base de datos permite versionar, actualizar y escalar componentes de forma independiente.
...
1. Justifica por qué no instalarías PostgreSQL dentro del mismo contenedor que Tomcat.
2. Asigna una responsabilidad a cada servicio.
