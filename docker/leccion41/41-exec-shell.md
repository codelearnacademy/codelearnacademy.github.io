...
route: docker
lesson_id: leccion41
lesson_file: 41-exec-shell
lesson_number: "41"
title: Ejecutar comandos dentro de un contenedor
description: Utiliza `exec` para diagnosticar sin convertir cambios manuales en configuración permanente.
permalink: /docker/leccion41/
lessons:
...
Utiliza `exec` para diagnosticar sin convertir cambios manuales en configuración permanente.

## Qué vas a conseguir

- Comprender **docker exec**.
- Comprender **shell**.
- Comprender **diagnóstico**.
...
Si una reparación debe sobrevivir a la recreación, debe quedar en Dockerfile, Compose, configuración o código; no solo dentro de un contenedor vivo.
...
1. Entra en un contenedor y comprueba variables de entorno.
2. Explica por qué instalar paquetes manualmente dentro no es una solución reproducible.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion40/">← 40 · Logs</a>
  <a href="/docker/leccion42/">42 · Inspect →</a>
</div>
