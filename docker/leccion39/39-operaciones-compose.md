...
route: docker
lesson_id: leccion39
lesson_file: 39-operaciones-compose
lesson_number: "39"
title: Operaciones con Compose
description: Gestiona el ciclo de vida de un stack multicontenedor.
permalink: /docker/leccion39/
lessons:
...
---
# Operaciones con Compose

Gestiona el ciclo de vida de un stack multicontenedor.
...
Compose ofrece un punto de entrada reproducible para el equipo: menos comandos manuales, menos diferencias entre máquinas.
...
1. Arranca, inspecciona y detén un stack.
2. Sigue los logs de backend mientras haces una petición desde el navegador.
