...
route: docker
lesson_id: leccion50
lesson_file: 50-flujo-git-docker
lesson_number: "50"
title: Flujo Git + Docker
description: Integra construcción y pruebas de imágenes dentro del trabajo por ramas.
permalink: /docker/leccion50/
lessons:
...
Integra construcción y pruebas de imágenes dentro del trabajo por ramas.

## Qué vas a conseguir

- Comprender **feature branch**.
- Comprender **build**.
- Comprender **test**.
- Comprender **commit**.
...
La automatización CI repetirá este flujo para evitar depender solo de la disciplina manual del desarrollador.
...
1. Implementa un cambio y valida el stack antes de abrir PR.
2. Documenta en el PR qué comprobaciones ejecutaste.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion49/">← 49 · Docker y Git</a>
  <a href="/docker/leccion51/">51 · Nombrado de imágenes →</a>
</div>
