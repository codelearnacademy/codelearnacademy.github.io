...
route: docker
lesson_id: leccion16
lesson_file: 16-copy-contexto-build
lesson_number: "16"
title: COPY y contexto de construcción
description: Comprende qué archivos puede ver Docker durante `docker build`.
permalink: /docker/leccion16/
lessons:
...
---
# COPY y contexto de construcción

Comprende qué archivos puede ver Docker durante `docker build`.

## Qué vas a conseguir

- Comprender **build context**.
- Comprender **COPY**.
- Comprender **ruta relativa**.
- Comprender **envío de contexto**.
...
El punto final define el contexto. `COPY` solo puede acceder a archivos incluidos en ese contexto.
...
La selección del contexto afecta rendimiento y seguridad. No conviene enviar `.git`, caches, secretos o artefactos innecesarios al builder.
...
1. Intenta copiar un archivo fuera del contexto y analiza el error.
2. Reduce el contexto de un proyecto grande.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion15/">← 15 · Imágenes base</a>
