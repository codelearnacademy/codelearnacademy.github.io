...
route: docker
lesson_id: leccion56
lesson_file: 56-publicacion-automatica
lesson_number: "56"
title: Publicación automática
description: Publica imágenes solo para ramas o tags definidos por una política.
permalink: /docker/leccion56/
lessons:
...
Publica imágenes solo para ramas o tags definidos por una política.

## Qué vas a conseguir

- Comprender **release tag**.
- Comprender **registry push**.
- Comprender **version**.
- Comprender **promotion**.
...
La versión puede sincronizarse entre Git, Maven y tags Docker, aunque cada sistema tiene su propio formato.
...
1. Define reglas para `main`, branches y tags.
2. Evita que un commit cualquiera sobrescriba una release estable.
...
<div class="cla-lesson-nav">
  ...
  <a href="/docker/leccion57/">57 · GitHub Actions y GitLab CI →</a>
</div>
