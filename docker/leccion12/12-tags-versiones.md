...
route: docker
lesson_id: leccion12
lesson_file: 12-tags-versiones
lesson_number: "12"
title: Tags y versiones
description: Usa tags para identificar versiones de una imagen de forma controlada.
permalink: /docker/leccion12/
lessons:
...
Usa tags para identificar versiones de una imagen de forma controlada.

## Qué vas a conseguir

- Comprender **tag**.
- Comprender **latest**.
- Comprender **versionado**.
- Comprender **release**.
...
Relaciona `artifactId:version` de Maven con `image:tag` de Docker y con tags Git como `v1.0.0`.
...
1. Crea tags `1.0.0` y `1.0` para la misma imagen.
2. Explica por qué depender únicamente de `latest` puede dificultar reproducibilidad.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion11/">← 11 · Docker Hub y registries</a>
  <a href="/docker/leccion13/">13 · Primer Dockerfile →</a>
</div>
