...
route: docker
lesson_id: leccion49
lesson_file: 49-docker-git
lesson_number: "49"
title: Docker y Git
description: Decide qué infraestructura se versiona y qué artefactos se regeneran.
permalink: /docker/leccion49/
lessons:
...
Decide qué infraestructura se versiona y qué artefactos se regeneran.

## Qué vas a conseguir

- Comprender **Dockerfile**.
- Comprender **compose.yml**.
- Comprender **.dockerignore**.
- Comprender **.gitignore**.
...
No versionar imágenes ni datos de volúmenes.
...
Git versiona la receta; Docker reconstruye la imagen. Es la misma separación que ya viste entre `pom.xml` y `target/`.
...
1. Revisa un repositorio y clasifica archivos versionables.
2. Añade Dockerfile y Compose en una rama Git con un commit descriptivo.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion48/">← 48 · Recursos y límites</a>
  <a href="/docker/leccion50/">50 · Flujo Git + Docker →</a>
</div>
