...
route: docker
lesson_id: leccion19
lesson_file: 19-capas-imagen
lesson_number: "19"
title: Capas de una imagen
description: Comprende cómo Docker construye imágenes a partir de capas reutilizables.
permalink: /docker/leccion19/
lessons:
...
Comprende cómo Docker construye imágenes a partir de capas reutilizables.
...
Observa cómo una imagen se compone de varias capas y metadatos.
...
La reutilización de capas permite ahorrar almacenamiento y acelerar builds, de forma distinta pero conceptualmente comparable a caches de dependencias.
...
1. Ejecuta `docker history` sobre dos imágenes.
2. Relaciona instrucciones del Dockerfile con capas generadas.
