...
route: docker
lesson_id: leccion30
lesson_file: 30-redes-docker
lesson_number: "30"
title: Redes Docker
description: Crea redes explícitas para que varios servicios se comuniquen de forma aislada.
permalink: /docker/leccion30/
lessons:
...
Crea redes explícitas para que varios servicios se comuniquen de forma aislada.

## Qué vas a conseguir

- Comprender **bridge network**.
- Comprender **docker network**.
- Comprender **aislamiento**.
- Comprender **conectividad**.
...
Una red Docker se parece a una red privada de aplicación. Kubernetes evoluciona este concepto con Services y networking de clúster.
...
1. Crea una red y conecta dos contenedores.
2. Inspecciona la red y localiza sus miembros.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion29/">← 29 · Comunicación entre contenedores</a>
