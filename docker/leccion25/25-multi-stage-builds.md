...
route: docker
lesson_id: leccion25
lesson_file: 25-multi-stage-builds
lesson_number: "25"
title: Multi-stage builds
description: Separa etapa de construcción y etapa de ejecución para obtener imágenes limpias.
permalink: /docker/leccion25/
lessons:
...
Separa etapa de construcción y etapa de ejecución para obtener imágenes limpias.

## Qué vas a conseguir

- Comprender **AS build**.
- Comprender **COPY --from**.
- Comprender **builder**.
- Comprender **runtime**.
...
Este patrón es especialmente importante para la arquitectura final:
...
Node         → build Angular
Nginx        → servir Angular
```


## Relación con otras tecnologías

Angular suele usar `node` para construir y `nginx` para servir; Go usa una imagen de compilación y una runtime mínima. Es uno de los patrones más transferibles de Docker.
...
1. Transforma un Dockerfile de una etapa en multi-stage.
2. Comprueba que Maven no existe en la imagen final.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion24/">← 24 · Maven dentro de Docker</a>
