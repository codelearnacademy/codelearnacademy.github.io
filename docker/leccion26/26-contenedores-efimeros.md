...
route: docker
lesson_id: leccion26
lesson_file: 26-contenedores-efimeros
lesson_number: "26"
title: Contenedores efímeros
description: Comprende por qué no debes guardar estado importante solo dentro del filesystem writable del contenedor.
permalink: /docker/leccion26/
lessons:
...
Comprende por qué no debes guardar estado importante solo dentro del filesystem writable del contenedor.

## Qué vas a conseguir

- Comprender **efímero**.
- Comprender **estado**.
- Comprender **recreación**.
...
Crea un archivo dentro de un contenedor, elimínalo y crea otro desde la misma imagen. El dato no forma parte de la imagen ni reaparece automáticamente.
...
Aplicaciones stateless son más sencillas de escalar y reemplazar. Las bases de datos requieren persistencia explícita.
...
1. Demuestra experimentalmente la pérdida de un dato al recrear un contenedor.
2. Clasifica qué datos de una API deberían ser efímeros y cuáles persistentes.
...
<div class="cla-lesson-nav">
  ...
  <a href="/docker/leccion27/">27 · Volúmenes →</a>
</div>
