...
route: docker
lesson_id: leccion18
lesson_file: 18-cmd-entrypoint
lesson_number: "18"
title: CMD y ENTRYPOINT
description: Distingue comando por defecto y ejecutable principal de un contenedor.
permalink: /docker/leccion18/
lessons:
...
Distingue comando por defecto y ejecutable principal de un contenedor.

## Qué vas a conseguir

- Comprender **CMD**.
- Comprender **ENTRYPOINT**.
...
El `ENTRYPOINT` fija el ejecutable y `CMD` puede aportar valores por defecto.
...
En scripts npm o comandos Maven también distinguimos herramienta y argumentos, pero Docker modela explícitamente el proceso principal del contenedor.
...
1. Ejecuta el contenedor sobrescribiendo el `CMD`.
2. Explica cuándo preferirías un solo `CMD`.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion17/">← 17 · .dockerignore</a>
  <a href="/docker/leccion19/">19 · Capas de una imagen →</a>
</div>
