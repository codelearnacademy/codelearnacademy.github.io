...
route: docker
lesson_id: leccion47
lesson_file: 47-healthchecks
lesson_number: "47"
title: Healthchecks
description: Distingue proceso iniciado de servicio preparado para recibir tráfico.
permalink: /docker/leccion47/
lessons:
...
Distingue proceso iniciado de servicio preparado para recibir tráfico.

## Qué vas a conseguir

- Comprender **HEALTHCHECK**.
- Comprender **readiness**.
- Comprender **liveness**.
...
Kubernetes separa readiness y liveness de forma más explícita. Docker/Compose ofrece mecanismos más simples pero relacionados.
...
1. Añade healthcheck a PostgreSQL.
2. Explica por qué `depends_on` por sí solo no garantiza que la base esté lista.
