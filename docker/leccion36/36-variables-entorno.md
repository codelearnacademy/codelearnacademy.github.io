...
route: docker
lesson_id: leccion36
lesson_file: 36-variables-entorno
lesson_number: "36"
title: Variables de entorno
description: Externaliza configuración sin reconstruir la imagen.
permalink: /docker/leccion36/
lessons:
...
Externaliza configuración sin reconstruir la imagen.
...
No incluyas contraseñas reales en repositorios públicos.
...
Spring usa variables/property sources, Angular puede recibir configuración en build/runtime mediante patrones específicos, Node usa `process.env`, Python `os.environ` y Go `os.Getenv`.
...
1. Configura una URL de base de datos mediante variables.
2. Distingue configuración no sensible de secretos.
