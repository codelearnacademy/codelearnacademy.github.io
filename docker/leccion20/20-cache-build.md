...
route: docker
lesson_id: leccion20
lesson_file: 20-cache-build
lesson_number: "20"
title: Caché de construcción
description: Ordena el Dockerfile para reutilizar capas y acelerar compilaciones.
permalink: /docker/leccion20/
lessons:
...
Ordena el Dockerfile para reutilizar capas y acelerar compilaciones.

## Qué vas a conseguir

- Comprender **cache**.
- Comprender **invalidación**.
- Comprender **orden de COPY**.
...
Cambiar código fuente no debería obligar siempre a descargar todas las dependencias.
...
La idea se parece a caches de `~/.m2`, npm o pip en CI: conservar trabajo estable y recalcular solo lo que cambia.
...
1. Mide un build inicial y otro sin cambios.
2. Modifica solo una clase y observa qué capas se reutilizan.
...
<div class="cla-lesson-nav">
  ...
  <a href="/docker/leccion21/">21 · Tamaño de imágenes →</a>
</div>
