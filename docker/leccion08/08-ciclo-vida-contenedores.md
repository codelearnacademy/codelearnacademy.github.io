...
route: docker
lesson_id: leccion08
lesson_file: 08-ciclo-vida-contenedores
lesson_number: "08"
title: Ciclo de vida de contenedores
description: Gestiona creación, parada, reinicio y eliminación de contenedores.
permalink: /docker/leccion08/
lessons:
...
Gestiona creación, parada, reinicio y eliminación de contenedores.

## Qué vas a conseguir

- Comprender **docker ps**.
- Comprender **stop**.
- Comprender **start**.
- Comprender **restart**.
...
El ciclo de vida de un contenedor no debe confundirse con el ciclo de vida Maven. Maven construye el artefacto; Docker ejecuta el entorno que lo contiene.
...
1. Crea dos contenedores y gestiona sus estados.
2. Predice qué comandos modifican el contenedor y cuáles solo consultan.
