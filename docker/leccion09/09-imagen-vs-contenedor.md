...
route: docker
lesson_id: leccion09
lesson_file: 09-imagen-vs-contenedor
lesson_number: "09"
title: Imagen frente a contenedor
description: Elimina una de las confusiones más frecuentes al empezar con Docker.
permalink: /docker/leccion09/
lessons:
...
Elimina una de las confusiones más frecuentes al empezar con Docker.

## Qué vas a conseguir

- Comprender **inmutabilidad**.
- Comprender **instancia**.
- Comprender **filesystem writable**.
- Comprender **estado**.
...
```text
Imagen ──docker run──> Contenedor A
      └─docker run──> Contenedor B
```

Ambos contenedores parten de la misma imagen, pero tienen estado de ejecución independiente.
...
La analogía clase/objeto puede ayudar al principio, pero no es exacta: una imagen es un conjunto de capas y metadatos, no una clase de programación.
...
1. Crea dos contenedores desde la misma imagen.
2. Modifica un archivo dentro de uno y comprueba si aparece en el otro.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion08/">← 08 · Ciclo de vida de contenedores</a>
  <a href="/docker/leccion10/">10 · Trabajar con imágenes →</a>
</div>
