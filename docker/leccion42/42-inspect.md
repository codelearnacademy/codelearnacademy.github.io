...
route: docker
lesson_id: leccion42
lesson_file: 42-inspect
lesson_number: "42"
title: Inspect
description: Obtén metadatos detallados de contenedores, imágenes, redes y volúmenes.
permalink: /docker/leccion42/
lessons:
...
Obtén metadatos detallados de contenedores, imágenes, redes y volúmenes.

## Qué vas a conseguir

- Comprender **docker inspect**.
- Comprender **JSON**.
- Comprender **mounts**.
- Comprender **network settings**.
...
La capacidad de inspección sistemática evita diagnosticar por intuición.
...
1. Localiza la IP, mounts y variables de un contenedor de laboratorio.
2. Compara `docker ps` con `docker inspect`.
