...
route: docker
lesson_id: leccion46
lesson_file: 46-configuracion-externa
lesson_number: "46"
title: Configuración externa
description: Separa imagen inmutable de configuración dependiente del entorno.
permalink: /docker/leccion46/
lessons:
...
Separa imagen inmutable de configuración dependiente del entorno.

## Qué vas a conseguir

- Comprender **config**.
- Comprender **environment variables**.
- Comprender **profiles**.
- Comprender **runtime**.
...
api:1.0.0
  ├─ entorno dev → DB dev
  ├─ entorno test → DB test
  └─ entorno prod → DB prod
```
...
Este principio facilita CI/CD: promocionas el mismo artefacto entre entornos cambiando configuración, no recompilando código.
...
1. Ejecuta la misma imagen con dos valores de configuración.
2. Relaciona variables Docker con perfiles de Spring.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion45/">← 45 · Secretos</a>
  <a href="/docker/leccion47/">47 · Healthchecks →</a>
</div>
