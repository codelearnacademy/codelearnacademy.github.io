...
route: docker
lesson_id: leccion24
lesson_file: 24-maven-dentro-docker
lesson_number: "24"
title: Maven dentro de Docker
description: Construye código Java sin requerir Maven instalado en el host.
permalink: /docker/leccion24/
lessons:
...
---
# Maven dentro de Docker

Construye código Java sin requerir Maven instalado en el host.

## Qué vas a conseguir

- Comprender **builder image**.
- Comprender **Maven image**.
- Comprender **compilación encapsulada**.
...
Node puede compilar Angular dentro de una imagen Node; Go puede construir binarios en una etapa `golang`; el patrón es independiente del lenguaje.
...
1. Construye un proyecto usando una imagen Maven.
2. Compara requisitos del host con la lección anterior.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion23/">← 23 · Maven fuera de Docker</a>
  <a href="/docker/leccion25/">25 · Multi-stage builds →</a>
</div>
