...
route: docker
lesson_id: leccion52
lesson_file: 52-publicar-imagenes
lesson_number: "52"
title: Publicar imágenes
description: Autentica y publica imágenes en un registry.
permalink: /docker/leccion52/
lessons:
...
Autentica y publica imágenes en un registry.

## Qué vas a conseguir

- Comprender **docker login**.
- Comprender **docker push**.
- Comprender **registry auth**.
- Comprender **permissions**.
...
docker push ghcr.io/organizacion/tasks-backend:1.0.0
```
...
No guardes tokens de registry en el repositorio. En CI utiliza secretos y permisos mínimos.
...
1. Publica una imagen de laboratorio en un registry de tu elección.
2. Comprueba que otro equipo puede descargarla.
