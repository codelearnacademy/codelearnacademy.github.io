...
route: docker
lesson_id: leccion17
lesson_file: 17-dockerignore
lesson_number: "17"
title: .dockerignore
description: Evita enviar archivos innecesarios o sensibles al contexto de construcción.
permalink: /docker/leccion17/
lessons:
...
Evita enviar archivos innecesarios o sensibles al contexto de construcción.
...
Adapta el archivo según qué artefactos necesite realmente la construcción.
...
`.gitignore` controla Git; `.dockerignore` controla el contexto de build. Pueden compartir patrones, pero resuelven problemas distintos.
...
1. Crea `.dockerignore` para un monorepo Java + Angular.
2. Compara el tamaño del contexto antes y después.
...
<div class="cla-lesson-nav">
  ...
  <a href="/docker/leccion18/">18 · CMD y ENTRYPOINT →</a>
</div>
