...
route: docker
lesson_id: leccion58
lesson_file: 58-docker-vs-podman
lesson_number: "58"
title: Docker frente a Podman
description: Reconoce una alternativa compatible en muchos flujos sin convertir la ruta en un curso de Podman.
permalink: /docker/leccion58/
lessons:
...
---
# Docker frente a Podman

Reconoce una alternativa compatible en muchos flujos sin convertir la ruta en un curso de Podman.

## Qué vas a conseguir

- Comprender **Podman**.
- Comprender **daemonless**.
- Comprender **OCI**.
- Comprender **CLI compatibility**.
...
Muchos comandos son conceptualmente equivalentes:
...
Aprender estándares de imágenes, redes, volúmenes y registries es más útil que memorizar únicamente una implementación.
...
1. Enumera semejanzas y diferencias a nivel conceptual.
2. Explica qué conocimientos de Docker transferirías directamente.
