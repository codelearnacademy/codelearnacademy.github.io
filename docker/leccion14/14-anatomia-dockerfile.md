...
route: docker
lesson_id: leccion14
lesson_file: 14-anatomia-dockerfile
lesson_number: "14"
title: Anatomía de un Dockerfile
description: Comprende las instrucciones más utilizadas y cuándo se ejecutan.
permalink: /docker/leccion14/
lessons:
...
Comprende las instrucciones más utilizadas y cuándo se ejecutan.
...
Dockerfile es una receta declarativa de construcción. Se puede comparar conceptualmente con un build script, aunque su objetivo es producir una imagen, no compilar por sí mismo el código.
...
1. Explica cada instrucción del ejemplo.
2. Añade una variable de entorno no sensible y léela desde la aplicación.
