...
route: docker
lesson_id: leccion51
lesson_file: 51-nombrado-imagenes
lesson_number: "51"
title: Nombrado de imágenes
description: Diseña nombres y tags coherentes para imágenes de frontend y backend.
permalink: /docker/leccion51/
lessons:
...
Diseña nombres y tags coherentes para imágenes de frontend y backend.

## Qué vas a conseguir

- Comprender **repository**.
- Comprender **tag**.
- Comprender **registry namespace**.
- Comprender **semver**.
...
```text
ghcr.io/organizacion/tasks-backend:1.0.0
ghcr.io/organizacion/tasks-frontend:1.0.0
```
...
Una política coherente facilita promoción y rollback en CI/CD.
...
1. Propón un esquema para snapshots y releases.
2. Relaciona tags Git y tags Docker.
...
<div class="cla-lesson-nav">
  ...
  <a href="/docker/leccion52/">52 · Publicar imágenes →</a>
</div>
