...
route: docker
lesson_id: leccion60
lesson_file: 60-docker-kubernetes
lesson_number: "60"
title: Docker y Kubernetes
description: Prepara el salto futuro a orquestación sin mezclar responsabilidades.
permalink: /docker/leccion60/
lessons:
...
Prepara el salto futuro a orquestación sin mezclar responsabilidades.

## Qué vas a conseguir

- Comprender **Pod**.
- Comprender **Deployment**.
- Comprender **Service**.
- Comprender **orquestación**.
...
Compose describe un stack en un entorno relativamente simple; Kubernetes añade scheduling, replicas, service discovery y recuperación a escala.
...
1. Relaciona contenedor Docker con Pod sin afirmar que sean idénticos.
2. Explica qué problemas aparecen al pasar de un host a decenas de nodos.
...
<div class="cla-lesson-nav">
  <a href="/docker/leccion59/">← 59 · Docker frente a máquinas virtuales revisitado</a>
  <a href="/docker/leccion61/">61 · Proyecto final · Plataforma Java + Spring + Angular + PostgreSQL con CI/CD →</a>
</div>
