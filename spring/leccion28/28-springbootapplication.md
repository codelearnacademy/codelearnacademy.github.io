...
- Comprender el concepto de **@SpringBootApplication**.
...
1. Reproduce el ejemplo de **@SpringBootApplication** y documenta qué cambia en el proyecto.
