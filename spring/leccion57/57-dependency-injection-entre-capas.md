...
route: spring
lesson_id: leccion57
lesson_file: 57-dependency-injection-entre-capas
lesson_number: "57"
title: Dependency Injection entre capas
description: Organiza una aplicación separando HTTP, negocio y persistencia con dependencias explícitas.
permalink: /spring/leccion57/
lessons:
...
---
# Dependency Injection entre capas

Organiza una aplicación separando HTTP, negocio y persistencia con dependencias explícitas.

## Qué vas a conseguir

- Comprender el concepto de **Dependency Injection entre capas**.
...
1. Reproduce el ejemplo de **Dependency Injection entre capas** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion56/">← 56 · Responsabilidad del Repository</a>
