...
- Comprender el concepto de **Secretos**.
...
en Git. Usa variables protegidas o un gestor de secretos.
...
1. Reproduce el ejemplo de **Secretos** y documenta qué cambia en el proyecto.
