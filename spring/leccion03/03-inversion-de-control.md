...
route: spring
lesson_id: leccion03
lesson_file: 03-inversion-de-control
lesson_number: "03"
...
- Comprender el concepto de **Inversión de Control**.
...
```text
Sin IoC:
PedidoService → new EmailService()

Con IoC:
Spring → crea EmailService
Spring → crea PedidoService(EmailService)
```
...
1. Reproduce el ejemplo de **Inversión de Control** y documenta qué cambia en el proyecto.
