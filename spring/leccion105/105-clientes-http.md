...
- Comprender el concepto de **Clientes HTTP**.
...
Construye un cliente HTTP tipado o declarativo para consumir otra API y compáralo con llamadas manuales de bajo nivel.
...
1. Reproduce el ejemplo de **Clientes HTTP** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion104/">← 104 · Cache</a>
