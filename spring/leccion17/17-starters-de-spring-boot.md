...
- Comprender el concepto de **Starters de Spring Boot**.
...
y localiza Spring MVC y Tomcat.
...
1. Reproduce el ejemplo de **Starters de Spring Boot** y documenta qué cambia en el proyecto.
