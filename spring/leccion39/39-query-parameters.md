...
- Comprender el concepto de **Query parameters**.
...
```java
@GetMapping
List<TaskDto> search(@RequestParam(required = false) Boolean completed) {
    return service.search(completed);
}
```
...
1. Reproduce el ejemplo de **Query parameters** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion38/">← 38 · Path variables</a>
  <a href="/spring/leccion40/">40 · Request body y JSON →</a>
</div>
