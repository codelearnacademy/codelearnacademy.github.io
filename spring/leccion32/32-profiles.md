...
- Comprender el concepto de **Profiles**.
...
Activa uno con `SPRING_PROFILES_ACTIVE=dev`.
...
1. Reproduce el ejemplo de **Profiles** y documenta qué cambia en el proyecto.
