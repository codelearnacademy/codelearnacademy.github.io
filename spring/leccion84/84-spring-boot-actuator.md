...
- Comprender el concepto de **Spring Boot Actuator**.
...
y revisa qué endpoints no deberían ser públicos.
...
1. Reproduce el ejemplo de **Spring Boot Actuator** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion83/">← 83 · Logging</a>
  <a href="/spring/leccion85/">85 · Métricas con Micrometer →</a>
</div>
