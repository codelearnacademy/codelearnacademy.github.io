...
- Comprender el concepto de **@Configuration y @Bean**.
...
1. Reproduce el ejemplo de **@Configuration y @Bean** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion19/">← 19 · Beans</a>
  <a href="/spring/leccion21/">21 · Component scanning →</a>
</div>
