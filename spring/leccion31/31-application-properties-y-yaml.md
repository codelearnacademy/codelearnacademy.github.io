...
- Comprender el concepto de **application.properties y YAML**.
...
1. Reproduce el ejemplo de **application.properties y YAML** y documenta qué cambia en el proyecto.
