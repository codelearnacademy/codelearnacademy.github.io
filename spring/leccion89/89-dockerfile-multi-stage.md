...
- Comprender el concepto de **Dockerfile multi-stage**.
...
1. Reproduce el ejemplo de **Dockerfile multi-stage** y documenta qué cambia en el proyecto.
