...
- Comprender el concepto de **Autenticación para APIs**.
...
Compara sesión/cookie con token bearer para una API. No implementes JWT hasta comprender expiración, firma, almacenamiento y revocación.
...
1. Reproduce el ejemplo de **Autenticación para APIs** y documenta qué cambia en el proyecto.
