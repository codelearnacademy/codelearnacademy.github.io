...
route: spring
lesson_id: leccion44
lesson_file: 44-manejo-global-de-errores
lesson_number: "44"
...
- Comprender el concepto de **Manejo global de errores**.
...
class ApiExceptionHandler {
    ...
    ResponseEntity<?> notFound(TaskNotFoundException ex) { ... }
}
```
...
1. Reproduce el ejemplo de **Manejo global de errores** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion43/">← 43 · ResponseEntity</a>
  <a href="/spring/leccion45/">45 · Validación →</a>
</div>
