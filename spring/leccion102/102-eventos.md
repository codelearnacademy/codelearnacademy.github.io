...
- Comprender el concepto de **Eventos**.
...
```java
publisher.publishEvent(new TaskCompletedEvent(id));
```

Crea un listener que registre el evento sin acoplar el servicio al consumidor.
...
1. Reproduce el ejemplo de **Eventos** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion101/">← 101 · Proxies de Spring</a>
  <a href="/spring/leccion103/">103 · Scheduling →</a>
</div>
