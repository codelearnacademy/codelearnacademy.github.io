...
route: spring
lesson_id: leccion08
lesson_file: 08-spring-framework-frente-a-spring-boot
lesson_number: "08"
title: Spring Framework frente a Spring Boot
description: Sitúa Spring Framework y Spring Boot dentro del ecosistema y distingue sus responsabilidades.
permalink: /spring/leccion08/
lessons:
...
---
# Spring Framework frente a Spring Boot

Sitúa Spring Framework y Spring Boot dentro del ecosistema y distingue sus responsabilidades.

## Qué vas a conseguir

- Comprender el concepto de **Spring Framework frente a Spring Boot**.
...
1. Reproduce el ejemplo de **Spring Framework frente a Spring Boot** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion07/">← 07 · El ecosistema Spring</a>
  <a href="/spring/leccion09/">09 · Historia de Spring y Spring Boot →</a>
</div>
