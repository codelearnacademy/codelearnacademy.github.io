...
route: spring
lesson_id: leccion73
lesson_file: 73-testing-de-servicios
lesson_number: "73"
...
- Comprender el concepto de **Testing de servicios**.
...
1. Reproduce el ejemplo de **Testing de servicios** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion72/">← 72 · @ConfigurationProperties</a>
  <a href="/spring/leccion74/">74 · Testing del contexto Spring →</a>
</div>
