...
- Comprender el concepto de **Variables de entorno**.
...
```bash
export SPRING_DATASOURCE_URL=jdbc:postgresql://db:5432/tasks
```
...
1. Reproduce el ejemplo de **Variables de entorno** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  ...
  <a href="/spring/leccion71/">71 · Secretos →</a>
</div>
