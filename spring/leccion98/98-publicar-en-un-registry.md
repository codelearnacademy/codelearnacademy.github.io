...
- Comprender el concepto de **Publicar en un registry**.
...
```text
ghcr.io/organizacion/tasks-api:1.0.0
```
...
1. Reproduce el ejemplo de **Publicar en un registry** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  ...
  <a href="/spring/leccion99/">99 · CD: desplegar una versión →</a>
</div>
