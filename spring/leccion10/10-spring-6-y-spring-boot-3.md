...
Compara imports antiguos y modernos:

```java
// generaciones antiguas
javax.servlet.*

// Spring 6 / Boot 3 y posteriores
jakarta.servlet.*
```
...
1. Reproduce el ejemplo de **Spring 6 y Spring Boot 3** y documenta qué cambia en el proyecto.
