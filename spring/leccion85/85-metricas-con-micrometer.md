...
route: spring
lesson_id: leccion85
lesson_file: 85-metricas-con-micrometer
lesson_number: "85"
title: Métricas con Micrometer
description: Prepara la aplicación para operación mediante logs, health, métricas y configuración.
permalink: /spring/leccion85/
lessons:
...
Prepara la aplicación para operación mediante logs, health, métricas y configuración.

## Qué vas a conseguir

- Comprender el concepto de **Métricas con Micrometer**.
...
Esta lección pertenece al bloque **Producción y observabilidad**.
...
Usa Micrometer para entender contadores, timers y gauges sin acoplar la aplicación a un backend de métricas concreto.



## Relación con el resto de la ruta

Actuator y Micrometer conectan la aplicación con Docker, CI/CD y plataformas de monitorización.
...
1. Reproduce el ejemplo de **Métricas con Micrometer** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion84/">← 84 · Spring Boot Actuator</a>
  <a href="/spring/leccion86/">86 · Healthchecks →</a>
</div>
