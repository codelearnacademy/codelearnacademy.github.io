...
- Comprender el concepto de **Qué es Tomcat**.
...
Tomcat implementa el stack Servlet. En una aplicación MVC:

```text
socket HTTP → Tomcat → Servlet API → DispatcherServlet → Spring MVC
```
...
1. Reproduce el ejemplo de **Qué es Tomcat** y documenta qué cambia en el proyecto.
