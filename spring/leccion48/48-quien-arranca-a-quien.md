...
- Comprender el concepto de **¿Quién arranca a quién?**.
...
```text
WAR tradicional:
Tomcat → despliega aplicación Spring

JAR Boot:
aplicación Boot → arranca Tomcat
```
...
1. Reproduce el ejemplo de **¿Quién arranca a quién?** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion47/">← 47 · Tomcat embebido</a>
  <a href="/spring/leccion49/">49 · Cambiar Tomcat por otro servidor →</a>
</div>
