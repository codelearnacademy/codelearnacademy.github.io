...
- Comprender el concepto de **Proxies de Spring**.
...
```text
llamada → proxy Spring → interceptor → objeto real
```

Esto explica por qué ciertas anotaciones dependen de que la llamada atraviese el proxy.
...
1. Reproduce el ejemplo de **Proxies de Spring** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion100/">← 100 · AOP</a>
  <a href="/spring/leccion102/">102 · Eventos →</a>
</div>
