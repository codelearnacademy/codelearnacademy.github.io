...
- Comprender el concepto de **Testcontainers**.
...
La prueba controla el ciclo de vida de la base.
...
1. Reproduce el ejemplo de **Testcontainers** y documenta qué cambia en el proyecto.
