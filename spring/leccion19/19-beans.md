...
- Comprender el concepto de **Beans**.
...
```java
Object bean = context.getBean("pedidoService");
```

Un bean es un objeto creado, configurado y gestionado por el contenedor Spring.
...
1. Reproduce el ejemplo de **Beans** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion18/">← 18 · ApplicationContext</a>
  <a href="/spring/leccion20/">20 · @Configuration y @Bean →</a>
</div>
