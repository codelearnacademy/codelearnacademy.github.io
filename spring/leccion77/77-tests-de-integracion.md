...
route: spring
lesson_id: leccion77
lesson_file: 77-tests-de-integracion
lesson_number: "77"
...
- Comprender el concepto de **Tests de integración**.
...
Diseña un test que atraviese varias capas.
...
1. Reproduce el ejemplo de **Tests de integración** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion76/">← 76 · Testing del Repository</a>
  <a href="/spring/leccion78/">78 · Testcontainers →</a>
</div>
