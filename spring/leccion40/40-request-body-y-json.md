...
- Comprender el concepto de **Request body y JSON**.
...
```json
{"title":"Estudiar Spring","completed":false}
```

y recíbelo como DTO con `@RequestBody`.
...
1. Reproduce el ejemplo de **Request body y JSON** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion39/">← 39 · Query parameters</a>
  <a href="/spring/leccion41/">41 · DTOs →</a>
</div>
