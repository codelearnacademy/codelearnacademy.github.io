...
Analiza la transacción como preocupación transversal que Spring aplica mediante infraestructura AOP.
...
1. Reproduce el ejemplo de **AOP** y documenta qué cambia en el proyecto.
