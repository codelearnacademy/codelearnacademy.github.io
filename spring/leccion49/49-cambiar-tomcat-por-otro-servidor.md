...
route: spring
lesson_id: leccion49
lesson_file: 49-cambiar-tomcat-por-otro-servidor
lesson_number: "49"
title: Cambiar Tomcat por otro servidor
description: Comprende el papel de Tomcat, el servidor embebido y el despliegue tradicional mediante WAR.
permalink: /spring/leccion49/
lessons:
...
---
# Cambiar Tomcat por otro servidor

Comprende el papel de Tomcat, el servidor embebido y el despliegue tradicional mediante WAR.

## Qué vas a conseguir

- Comprender el concepto de **Cambiar Tomcat por otro servidor**.
...
Excluye Tomcat y añade Jetty como ejercicio conceptual. Comprueba qué cambia en el árbol Maven.
...
1. Reproduce el ejemplo de **Cambiar Tomcat por otro servidor** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion48/">← 48 · ¿Quién arranca a quién?</a>
  <a href="/spring/leccion50/">50 · JAR ejecutable →</a>
</div>
