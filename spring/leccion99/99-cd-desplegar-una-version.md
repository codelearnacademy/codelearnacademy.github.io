...
route: spring
lesson_id: leccion99
lesson_file: 99-cd-desplegar-una-version
lesson_number: "99"
title: "CD: desplegar una versión"
description: Integra Spring con Git, Maven, imágenes Docker, registries y despliegues automatizados.
permalink: /spring/leccion99/
lessons:
...
1. Reproduce el ejemplo de **CD: desplegar una versión** y documenta qué cambia en el proyecto.
