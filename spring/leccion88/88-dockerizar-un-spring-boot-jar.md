...
route: spring
lesson_id: leccion88
lesson_file: 88-dockerizar-un-spring-boot-jar
lesson_number: "88"
title: Dockerizar un Spring Boot JAR
description: Empaqueta y ejecuta Spring Boot de forma reproducible con Docker y PostgreSQL.
permalink: /spring/leccion88/
lessons:
...
---
# Dockerizar un Spring Boot JAR

Empaqueta y ejecuta Spring Boot de forma reproducible con Docker y PostgreSQL.

## Qué vas a conseguir

- Comprender el concepto de **Dockerizar un Spring Boot JAR**.
...
WORKDIR /app
COPY target/tasks-api.jar app.jar
...
1. Reproduce el ejemplo de **Dockerizar un Spring Boot JAR** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  ...
  <a href="/spring/leccion89/">89 · Dockerfile multi-stage →</a>
</div>
