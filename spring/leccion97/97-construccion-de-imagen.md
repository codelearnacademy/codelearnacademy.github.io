...
route: spring
lesson_id: leccion97
lesson_file: 97-construccion-de-imagen
lesson_number: "97"
...
- Comprender el concepto de **Construcción de imagen**.
...
Solo construye la imagen si `verify` finaliza correctamente.
...
1. Reproduce el ejemplo de **Construcción de imagen** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion96/">← 96 · CI para Spring Boot</a>
  <a href="/spring/leccion98/">98 · Publicar en un registry →</a>
</div>
