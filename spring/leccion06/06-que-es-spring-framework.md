...
route: spring
lesson_id: leccion06
lesson_file: 06-que-es-spring-framework
lesson_number: "06"
...
- Comprender el concepto de **Qué es Spring Framework**.
...
Después indica cuáles usarías en una API REST sencilla.
...
1. Reproduce el ejemplo de **Qué es Spring Framework** y documenta qué cambia en el proyecto.
