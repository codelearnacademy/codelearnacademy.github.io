...
route: spring
lesson_id: leccion42
lesson_file: 42-codigos-de-estado-http
lesson_number: "42"
...
- Comprender el concepto de **Códigos de estado HTTP**.
...
Relaciona escenarios:

```text
GET correcto → 200
creación → 201
borrado sin body → 204
dato inválido → 400
no existe → 404
conflicto → 409
```
...
1. Reproduce el ejemplo de **Códigos de estado HTTP** y documenta qué cambia en el proyecto.
