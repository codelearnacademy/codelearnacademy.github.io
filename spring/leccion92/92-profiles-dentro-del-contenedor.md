...
route: spring
lesson_id: leccion92
lesson_file: 92-profiles-dentro-del-contenedor
lesson_number: "92"
title: Profiles dentro del contenedor
description: Empaqueta y ejecuta Spring Boot de forma reproducible con Docker y PostgreSQL.
permalink: /spring/leccion92/
lessons:
...
---
# Profiles dentro del contenedor

Empaqueta y ejecuta Spring Boot de forma reproducible con Docker y PostgreSQL.

## Qué vas a conseguir

- Comprender el concepto de **Profiles dentro del contenedor**.
...
1. Reproduce el ejemplo de **Profiles dentro del contenedor** y documenta qué cambia en el proyecto.
