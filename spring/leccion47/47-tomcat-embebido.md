...
- Comprender el concepto de **Tomcat embebido**.
...
java -jar app.jar
   ↓
Spring Boot inicia Tomcat embebido
   ↓
puerto 8080
```
...
1. Reproduce el ejemplo de **Tomcat embebido** y documenta qué cambia en el proyecto.
