...
route: spring
lesson_id: leccion72
lesson_file: 72-configurationproperties
lesson_number: "72"
...
- Comprender el concepto de **@ConfigurationProperties**.
...
public record TasksProperties(int maxPageSize, String defaultOwner) {}
```
...
1. Reproduce el ejemplo de **@ConfigurationProperties** y documenta qué cambia en el proyecto.
