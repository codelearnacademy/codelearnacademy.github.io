...
- Comprender el concepto de **Path variables**.
...
1. Reproduce el ejemplo de **Path variables** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion37/">← 37 · POST</a>
