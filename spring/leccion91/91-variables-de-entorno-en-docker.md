...
route: spring
lesson_id: leccion91
lesson_file: 91-variables-de-entorno-en-docker
lesson_number: "91"
...
- Comprender el concepto de **Variables de entorno en Docker**.
...
Pasa `SPRING_DATASOURCE_*` mediante Compose y elimina credenciales del `application.yml`.
...
1. Reproduce el ejemplo de **Variables de entorno en Docker** y documenta qué cambia en el proyecto.
...
<div class="cla-lesson-nav">
  <a href="/spring/leccion90/">← 90 · Spring Boot + PostgreSQL con Compose</a>
