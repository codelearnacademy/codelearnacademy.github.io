...
- Comprender el concepto de **Ciclo de vida del bean**.
...
1. Reproduce el ejemplo de **Ciclo de vida del bean** y documenta qué cambia en el proyecto.
